 ...
 * Description: Program 3 - Driver class
 */
...
public class Program4 {
	...
	public static void main(String[] args) throws IOException {
		FileWriter output = new FileWriter("Program3.out");
		...
		System.out.println("Processed " + counter + " lines and stored them in Program3.out");
	}
	...
	public static String InfixToPostfix(String s) {
		LinkedListStackClass opStack = new LinkedListStackClass();
		String resultString = "";
